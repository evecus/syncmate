...
abstract final class Constants {
  ...
  /// 设备间长连接（连接管理，独立于剪切板 WS）。
  static const String connectionWsPath = '/api/connection/ws';
  static const Duration connectionHeartbeatInterval = Duration(seconds: 15);
  static const Duration connectionHeartbeatTimeout = Duration(seconds: 30);
  static const Duration connectionReconnectMax = Duration(seconds: 60);
